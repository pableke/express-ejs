...
function isoFloat(val, s, d, n) { return isset(val) ? fnFloat("" + val, s, d, n, str.lastIndexOf(DOT)) : null; } //Float to String
function fmtFloat(str, s, d, n) { return str && fnFloat(str, s, d, n, str.lastIndexOf(d)); } //String (representing float) to String
