...
router.get("/filter.html", admin.list, admin.errList).get("/search.html", admin.list, admin.errList);
router.get("/filtrar.html", admin.list, admin.errList).get("/buscar.html", admin.list, admin.errList);
...
router.post("/save.html", admin.save, admin.error);
router.post("/duplicate.html", admin.duplicate, admin.error);

router.get("/pass.html", pass.view).get("/password.html", pass.view);
router.post("/pass.html", pass.save, pass.error)
	.post("/password.html", pass.save, pass.error);

router.get("/profile.html", profile.view).get("/perfil.html", profile.view);
router.post("/profile.html", profile.save, profile.error)
	.post("/perfil.html", profile.save, profile.error);
